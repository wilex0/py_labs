...
### `append_products(quantity)` - позволяет добавить необходимое количество продукта
### `buy(quantity)` - позволяет купить необходимое количество продукта
### `print_history` - позволяет удобно вывести историю скидок на продукт
...
## /lab01/demo.py
### Сценарий 1 - Создание объекта, добавление скидок в историю скидок и вывод в поток вывода в виде стилизованной таблицы
![cc1](../../images/lab01/cc1.png)
### Сценарий 2 - Покупка определённого количества продукта, добавление некоторого количества продукта
![cc2](../../images/lab01/cc2.png)
### Сценарий 3 - Запись объекта в json-формате и создание объекта класса из файла с помощью альтернативного конструктора
![cc3](../../images/lab01/cc3.png)
### Сценарий 4 - Изменение свойств объекта, обработка возможных ошибок
